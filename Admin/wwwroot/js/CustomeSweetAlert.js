...
async function Rangerswal() {
    ...
    for (var x = 0; x < ProjectView.Quantity; x++) {
        schedulerhtml += "<div class='row clearfix'><div class='col-sm-6'><div class='input-group'><div class='input-group-prepend'><span class='input-group-text'><i class='zmdi zmdi-time'></i></span></div><input type='text' value='" + today + "' class='form-control timepicker' id='" + x + "timer' placeholder='Please choose a time...'></div></div><div class='col-sm-6'><select class='form-control show-tick' id='" + x + "selecttime' onchange='Settime(" + x + ")'><option value=''>-- Time --</option><option value='09:30:00 AM'>Early 9:30 am</option><option value='11:00:00 AM'>Early2 11:00 am</option><option value='01:30:00 PM'>Afternoon1 1:30 pm</option><option value='03:00:00 PM'>Afternoon2 3:00 pm</option><option value='5:30:00 PM'>Evening1 5:30 pm</option><option value='7:30:00 PM'>Evening2 7:30 m</option></select></div></div><br />";
    }
    await Swal.fire({
        title: 'Select time',
        html: schedulerhtml,
